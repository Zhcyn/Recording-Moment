...
extension NoteListViewController {
  ...
  override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    cell.deleteMemoAction = { memo in
      let alert = UIAlertController(title: "Delete note", message: nil, preferredStyle: UIAlertController.Style.alert)
      alert.addAction(UIAlertAction(title: "Cancel", style: UIAlertAction.Style.cancel, handler: nil))
      alert.addAction(UIAlertAction(title: "Delete", style: UIAlertAction.Style.destructive, handler: { (action) -> Void in
...
private extension NoteListViewController {
  ...
  @objc func evernoteAuth() {
    if ENSession.shared.isAuthenticated {
      let alert = UIAlertController(title: "Exit Evernote?", message: nil, preferredStyle: UIAlertController.Style.alert)
      alert.addAction(UIAlertAction(title: "Cancel", style: .cancel, handler: nil))
      alert.addAction(UIAlertAction(title: "Exit", style: UIAlertAction.Style.destructive, handler: { (action) -> Void in
